...
.PHONY: lab-test-tun lab-test-tun-ipv6 lab-test-tun-imported-profile lab-test-tun-imported-egress lab-test-tun-device-policy lab-down lab-destroy
...
lab-test-tun-ipv6:
	OMG_LAB_MIHOMO_PROFILE=tests/lab/mihomo-profile.imported-tun-egress.yaml ./tests/lab/lab.sh test-tun-ipv6
